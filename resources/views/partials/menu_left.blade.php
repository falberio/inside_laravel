<div class="menu-left col-lg-2 col-md-3 col-sm-3">
	<input type="text" placeholder="Buscar">
	<nav>
		<ul>

			<li id="menu_left_groups"><i class="fas fa-users"></i>Grupos</li>
			...
			<li id="menu_left_meetings"><i class="fas fa-handshake"></i>Reuniones</li>
			<li class="menu-left-meetings-options options">
				<ul>
					<li><a href=""><i class="fas fa-plus"></i>Nueva reunión</a></li>
					<li><a href=""><i class="fas fa-handshake"></i>Ver reuniones</a></li>
